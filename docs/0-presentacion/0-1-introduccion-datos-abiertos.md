...
## 📌 Marco legal, normativa y guías en Castilla y León

La iniciativa de datos abiertos en Castilla y León se apoya en diferentes normas y documentos:

* **Ley 3/2015, de 4 de marzo**, de Transparencia y Participación Ciudadana de Castilla y León.
* **Acuerdo 17/2012, de 8 de marzo**, para implantar el modelo de Gobierno Abierto.
* **Ley 2/2010, de 11 de marzo**, de Derechos de los Ciudadanos en sus relaciones con la Administración.
...
## 📌 El portal de datos abiertos de la Junta
...
| -------------------------------------------------------- | ---------------------------------------- |
| Acceso gratuito a datos oficiales                        | Datos incompletos o con errores          |
| Variedad temática (cultura, transporte, medio ambiente…) | Formatos inconsistentes                  |
| Normativa y guías de apoyo                               | Requiere limpieza y normalización previa |
| Potencial de innovación educativa                        | Actualización no siempre garantizada     |
...
!!! question "Repaso"
    1. ¿Qué significa que un dato sea abierto?
    2. ¿Qué leyes respaldan la iniciativa de datos abiertos en Castilla y León?
    3. ¿Por qué es clave que los datos estén en formatos estándares y accesibles?
    4. ¿Qué criterios usarías para evaluar si un dataset es útil en una práctica web?
    5. ¿Cómo pueden beneficiarse los ciudadanos del uso de datos abiertos bien gestionados?
